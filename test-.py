#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To RED-MAFIA
...
def menu():
    ...
    print ''
    print 47 * '-'
    print ' \x1b[1;96m          Kaash Koi Toh Aesa Ho'
